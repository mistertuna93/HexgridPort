    ...
    return (
      <button 
        ...
        style={{
          ...
          padding: '12px 25px', borderRadius: '30px', cursor: 'pointer', backdropFilter: 'blur(10px)',
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '25px' }}>
        ...
        <button 
          ...
          style={{ background: 'transparent', border: 'none', color: 'white', cursor: 'pointer', fontSize: '1.2rem', opacity: 0.7 }}
        >✕</button>
      </div>
        ...
        {Object.keys(presets).map((p) => (
          <button 
            ...
            style={{
              ...
              textTransform: 'capitalize', fontSize: '0.9rem', fontWeight: 'bold', transition: 'all 0.2s'
            }}
            onMouseEnter={(e) => e.target.style.background = 'rgba(255,255,255,0.2)'}
      ...
      {/* Range Sliders mapping to Zustand Architecture */}
      {[
        ...
        <div key={ctrl.key} style={{ marginBottom: '18px' }}>
          ...
          <input 
            ...
            value={ctrl.val}
            onChange={(e) => setParam(ctrl.key, parseFloat(e.target.value))}
            style={{ width: '100%', cursor: 'pointer' }}
          />
        </div>
      ))}

      {/* Color Mapping dynamically to Shaders and R3F Background Contexts */}
        ...
        {[
          ...
          <div key={clr.key} style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '8px' }}>
            ...
            <input 
              ...
              style={{ width: '100%', height: '40px', border: 'none', borderRadius: '8px', cursor: 'pointer', padding: 0, background: 'transparent' }}
            />
          </div>
        ))}
      </div>
